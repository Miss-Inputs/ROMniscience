...
namespace ROMniscience.Handlers {
	class WiiU : Handler {
		...
		static readonly Dictionary<string, Tuple<string, IDictionary<int, string>>> RATING_TAGS = new Dictionary<string, Tuple<string, IDictionary<int, string>>>() {
			{"pc_cero", new Tuple<string, IDictionary<int, string>>("CERO", NintendoCommon.CERO_RATINGS)},
			{"pc_esrb", new Tuple<string, IDictionary<int, string>>("ESRB", NintendoCommon.ESRB_RATINGS)},
			{"pc_bbfc", new Tuple<string, IDictionary<int, string>>("BBFC", null)},
			{"pc_usk", new Tuple<string, IDictionary<int, string>>("USK", NintendoCommon.USK_RATINGS)},
			{"pc_pegi_gen", new Tuple<string, IDictionary<int, string>>("PEGI", NintendoCommon.PEGI_RATINGS)},
			{"pc_pegi_fin", new Tuple<string, IDictionary<int, string>>("PEGI (Finland)", NintendoCommon.FBFC_RATINGS)},
			{"pc_pegi_prt", new Tuple<string, IDictionary<int, string>>("PEGI (Portugal)", NintendoCommon.PEGI_PORTUGAL_RATINGS)},
			{"pc_pegi_bbfc", new Tuple<string, IDictionary<int, string>>("PEGI (UK)", NintendoCommon.PEGI_UK_RATINGS)},
			{"pc_cob", new Tuple<string, IDictionary<int, string>>("COB", null)},
			{"pc_grb", new Tuple<string, IDictionary<int, string>>("GRB", NintendoCommon.GRB_RATINGS)},
			{"pc_cgsrr", new Tuple<string, IDictionary<int, string>>("CGSRR", NintendoCommon.CGSRR_RATINGS)},
			{"pc_oflc", new Tuple<string, IDictionary<int, string>>("AGCB", NintendoCommon.AGCB_RATINGS)},
			{"pc_reserved1", new Tuple<string, IDictionary<int, string>>("<reserved 1>", null)},
			{"pc_reserved2", new Tuple<string, IDictionary<int, string>>("<reserved 2>", null)},
			{"pc_reserved3", new Tuple<string, IDictionary<int, string>>("<reserved 3>", null)},
		};
		...
		static void parseMetaXML(ROMInfo info, XElement doc) {
